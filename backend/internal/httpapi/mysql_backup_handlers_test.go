...
func TestMySQLBackupHandlerCreatesPlannedLockedAuditedSSETaskWithServerOwnedSettings(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/v2/apps/instances/"+instance.ID+"/backup", strings.NewReader(`{"name":"nightly","threads":12,"maxRateMBps":96,"schemas":["orders"]}`))
