...
func TestMySQLBackupCatalogContainsEveryTaskStepAndStableErrorMessageInBothLocales(t *testing.T) {
	...
	keys := []string{
		...
		"mysql.backup.retentionCleanupFailed", "mysql.backup.verificationFailed",
		"mysql.backup.verificationRecordFailed",
	...
	stableCodes := []string{
		...
		"MYSQL_BACKUP_STANDALONE_REQUIRED", "MYSQL_BACKUP_VERIFY_NOT_ALLOWED",
		"MYSQL_BACKUP_VERIFY_PLAN_STORE_FAILED", "MYSQL_BACKUP_VERIFY_FAILED",
		"MYSQL_BACKUP_VERIFICATION_RECORD_FAILED", "MYSQL_BACKUP_ID_INVALID",
		"MYSQL_BACKUP_DELETE_NOT_FOUND", "MYSQL_BACKUP_DELETE_LOOKUP_FAILED",
		"MYSQL_BACKUP_DELETE_NOT_ALLOWED", "MYSQL_BACKUP_DELETE_FAILED",
		"MYSQL_BACKUP_DELETE_RECORD_FAILED", "MYSQL_BACKUP_DELETE_FINALIZE_FAILED",
		"MYSQL_BACKUP_DELETE_ROLLBACK_FAILED", "MYSQL_BACKUP_LAST_SUCCESS_PROTECTED",
		"MYSQL_BACKUP_RETENTION_CLEANUP_FAILED",
		"MYSQL_BACKUP_SCHEMA_SELECTION_INVALID",
