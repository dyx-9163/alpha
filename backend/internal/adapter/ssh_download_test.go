...
func TestDownloadCommandAcceptsControlledMySQLArchive(t *testing.T) {
	...
	const want = "test ! -L '/aifar/apps/mysql/_backup/task-123/dump.tar' && test -f '/aifar/apps/mysql/_backup/task-123/dump.tar' && exec cat -- '/aifar/apps/mysql/_backup/task-123/dump.tar'"
	if command != want {
